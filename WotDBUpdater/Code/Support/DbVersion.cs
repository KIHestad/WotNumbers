...
namespace WotDBUpdater.Code
{
	class DBVersion
	{
		...
		public static int ExpectedNumber = 18; // <--------------------------------------- REMEMBER TO ADD DB VERSION NUMBER HERE - AND SUPPLY SQL SCRIPT BELOW
		...
		private static string UpgradeSQL(int version, ConfigData.dbType dbType)
		{
			...
			switch (version)
			{
				...
				case 17:
					...
					break;
				case 18:
					mssql = "DELETE FROM columnSelection; ALTER TABLE columnSelection ADD colDataType varchar(50) NOT NULL; ";
					sqlite = mssql;
					break;
				case 19:
					mssql = "";
