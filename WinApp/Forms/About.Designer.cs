namespace WinApp.Forms
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.AboutTheme.Controls.Add(this.lblDBver);
			this.AboutTheme.Controls.Add(this.badLabel3);
			this.AboutTheme.Controls.Add(this.badLabel2);
			this.AboutTheme.Controls.Add(this.badLabel1);
			this.AboutTheme.Controls.Add(this.lblAppVer);
			...
			this.AboutTheme.FormMargin = 0;
			this.AboutTheme.Image = null;
			this.AboutTheme.Location = new System.Drawing.Point(0, 0);
			...
			this.AboutTheme.TabIndex = 0;
			this.AboutTheme.Text = "About";
			this.AboutTheme.TitleHeight = 26;
			// 
			// linkWotNumbers
			// 
			this.linkWotNumbers.ActiveLinkColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			this.linkWotNumbers.AutoSize = true;
			...
			this.lblWN8ver.FontColor = System.Drawing.Color.FromArgb(((int)(((byte)(200)))), ((int)(((byte)(200)))), ((int)(((byte)(206)))));
			...
			this.lblDBver.FontColor = System.Drawing.Color.FromArgb(((int)(((byte)(200)))), ((int)(((byte)(200)))), ((int)(((byte)(206)))));
			...
			this.lblAppVer.FontColor = System.Drawing.Color.FromArgb(((int)(((byte)(200)))), ((int)(((byte)(200)))), ((int)(((byte)(206)))));
			...
			this.pictureBox1.Size = new System.Drawing.Size(351, 52);
			...
			this.AboutTheme.ResumeLayout(false);
			this.AboutTheme.PerformLayout();
		...
		private BadForm AboutTheme;
		private System.Windows.Forms.PictureBox pictureBox1;
		private BadLabel lblAppVer;
