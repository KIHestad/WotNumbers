...
namespace WinApp.Code
{
  ...
  //              XmlDocument xmlDoc = new XmlDocument();
		...
		//{
  //          msg = "Uploading dossier to vBAddict is no longer supported. It was fun back in the good old times when Phalynx ran the show ^_^";
  //          return false;
  //          //msg = "Starting upload dossier file to vBAddict...";
		...
		//{
            //msg = "Uploading battle to vBAddict is no longer supported.";
            //return false;
        ...
        //public static UploadReplayresult UploadReplay(int battleId, string replayFile, string playerName, string playerServer, string playerToken)
        //{
        //    UploadReplayresult result = new UploadReplayresult() {
        //        Message = "Uploading replay to vBAddict is no longer supported.",
        //        Success = false
        //    };
        //    return result;
