...
{
	public static class _todelete_ImportWotDossier2DB
	{

		#region importWotDossierHistory

		//public static void importWotDossierHistory(Form parentForm)
		//{
		...
		//	Code.MsgBox.Show("Imported " + row.ToString() + " records.", "Import finished", parentForm);
