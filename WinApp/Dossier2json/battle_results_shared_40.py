...
_VEH_BASE_RESULTS_PUBLIC = Meta((
 ...
 'checkpointProgress', tuple, (0, 0), None, 'max'), (
 'healthProgress', tuple, (0, 0), None, 'max'), (
 'eventPoints', int, -1, None, 'max'), (
 'generalPoints', int, -1, None, 'max'), (
 'generalID', int, -1, None, 'max'), (
 'generalLevel', int, -1, None, 'max'), (
 'frontLevel', int, -1, None, 'max'), (
 'retreat', int, 0, None, 'max'))
...
_AVATAR_BASE_PUBLIC_RESULTS = Meta((
 ...
 'generalID', int, -1, None, 'skip'), (
 'eventPoints', int, 0, None, 'skip'), (
 'generalPoints', int, 0, None, 'skip'))
