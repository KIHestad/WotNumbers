...
_VEH_CELL_RESULTS_PUBLIC = Meta((
 ...
 'primaryTurretShots', int, 0, None, 'sum'), (
 'secondaryTurretShots', int, 0, None, 'sum'), (
 'directHits', int, 0, None, 'sum'), (
 'secondaryDirectHits', int, 0, None, 'sum'), (
 'directTeamHits', int, 0, None, 'sum'), (
 'explosionHits', int, 0, None, 'sum'), (
 'piercings', int, 0, None, 'sum'), (
 'secondaryPiercings', int, 0, None, 'sum'), (
 'damageDealt', int, 0, None, 'sum'), (
 'primaryTurretDamage', int, 0, None, 'sum'), (
 'secondaryTurretDamage', int, 0, None, 'sum'), (
 ...
 'primaryTurretKills', int, 0, None, 'sum'), (
 'secondaryTurretKills', int, 0, None, 'sum'), (
 ...
 'bossTurretDamageReceived', int, 0, None, 'sum'), (
 'bossHazardDamageReceived', int, 0, None, 'sum'), (
 'bossHazardHits', int, 0, None, 'sum'), (
 'bossSecondaryTurretKill', int, 0, None, 'sum'), (
 'healthPickups', int, 0, None, 'sum'), (
 'totalHealed', int, 0, None, 'sum'))
