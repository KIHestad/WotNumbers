...
VEHICLE_DEVICE_TYPE_NAMES = (
 'engine', 'ammoBay', 'fuelTank', 'radio', 'track', 'gun', 'turretRotator', 'surveyingDevice', 'STUN_PLACEHOLDER', 'wheel')
...
VEH_CELL_RESULTS_EXTS = {'extPublic': {'recoveryMechanic': _buildMapsForExt((
   ...
   'extPrivate': {}, 'extServer': {'achievementsData': _buildMapsForExt((
                 ...
                 'battleXP': _buildMapsForExt((
                            'total', int, 0, None, 'sum')), 
                 'inBattleUpgrades': _buildMapsForExt((
                                    'modulesDescriptors', list, [], None, 'extend'))}}
...
_VEH_BASE_RESULTS_PRIVATE = Meta((
 ...
 'brPosInBattle', int, _THE_WORSE_BR_POSITION_IN_BATTLE, None, 'skip'))
...
_AVATAR_BASE_PRIVATE_RESULTS = Meta((
 ...
 'brPointsChanges', int, 0, None, 'skip'), (
 'brTitleChange', int, 0, None, 'skip'), (
 'accBRTitle', tuple, (0, 0), None, 'skip'), (
 'prevBRTitle', tuple, (0, 0), None, 'skip'), (
...
_AVATAR_BASE_PUBLIC_RESULTS_EXTS = {'playerRank': _buildMapsForExt((
   ...
   'battleRoyale': _buildMapsForExt((
                  'accPos', int, 0, None, 'skip'))}
